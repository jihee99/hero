...
public enum GroupErrorCode implements BaseErrorCode {
    ...
    FORBIDDEN_GROUP(BAD_REQUEST, "GROUP_400_2", "해당 호스트에 대한 접근 권한이 없습니다."),
    ALREADY_JOINED_GROUP(BAD_REQUEST, "GROUP_400_3", "이미 가입되어 있는 유저입니다."),
    NOT_MASTER_GROUP(BAD_REQUEST, "GROUP_400_4", "마스터 호스트 권한이 없는 유저입니다."),
    CANNOT_MODIFY_MASTER_GROUP_ROLE(BAD_REQUEST, "GROUP_400_5", "마스터 호스트의 권한은 변경할 수 없습니다."),
    NOT_ACCEPTED_GROUP(BAD_REQUEST, "GROUP_400_6", "아직 초대를 수락하지 않은 유저입니다."),
    GROUP_NOT_FOUND(NOT_FOUND, "GROUP_404_1", "해당 호스트를 찾을 수 없습니다."),
    GROUP_USER_NOT_FOUND(NOT_FOUND, "GROUP_404_2", "가입된 호스트 유저가 아닙니다."),
