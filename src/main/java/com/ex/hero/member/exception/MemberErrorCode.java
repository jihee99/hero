...
public enum MemberErrorCode implements BaseErrorCode {
	...
	USER_ALREADY_SIGNUP(HttpStatus.BAD_REQUEST, 3000, "이미 회원가입한 유저입니다."),
	@ExplainError("정지 처리된 유저일 경우 밣생하는 오류")
	USER_FORBIDDEN(HttpStatus.FORBIDDEN, 3001, "접근이 제한된 유저입니다."),
	@ExplainError("탈퇴한 유저로 접근하려는 경우")
	USER_ALREADY_DELETED(HttpStatus.FORBIDDEN, 3002, "이미 지워진 유저입니다."),
	@ExplainError("유저 정보를 찾을 수 없는 경우")
	USER_NOT_FOUND(HttpStatus.NOT_FOUND, 3003, "유저 정보를 찾을 수 없습니다."),
	USER_PHONE_INVALID(HttpStatus.BAD_REQUEST, 3004, "유저의 휴대폰 전화번호가 올바르지않습니다. 관리자에게 문의주세요"),
	@ExplainError("이미 판매자 등록신청을 한 경우")
	ALREADY_APPLIED_USER(HttpStatus.NOT_FOUND, 3005, "이미 신청한 회원입니다."),
	SECURITY_CONTEXT_NOT_FOUND(HttpStatus.NOT_FOUND, 3006, "security context not found");
